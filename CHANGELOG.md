...
- [x] `display-app/src/components/UserNode.tsx` — changed the expanded-panel wrapper to `pointerEvents: auto` and moved touch-isolation handlers onto the wrapper so the full transformed panel box captures touches instead of falling through to Pixi
